 ...
 <?php 
    ...
    <div class="z-depth-4" id="tabela">
        <table class="responsive-table z-depth-4 centered #00695c teal darken-3">
            <center><h3><i class="material-icons  medium">search</i>Pesquisar por cpf</h3></center>
            
            <div class="container">
                <div class="col s12" id="kk">  
                    <div class="row">
                        <form action="pesquisar_cpf.php" method="post">
                            <div class="input-field col s12">
                                <input placeholder="Ex: HHH3366" id="first_name" name="cpf_pesq" type="text" class="validate">
            ...
            <thead class="highlight red white-text">
              ...
              <?php 
                require './conexao.php';
                $cpf_pesq= @$_POST['cpf_pesq'];
                $consultar= "SELECT * FROM ordemservico WHERE cpf LIKE '%$cpf_pesq%' OR cpf LIKE '%$cpf_pesq%'";
