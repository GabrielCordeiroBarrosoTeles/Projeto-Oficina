        ...
        <table class="responsive-table z-depth-4 centered #00695c teal darken-3">
            ...
            <div class="container">
                <div class="col s12" id="kk">  
                    <div class="row">
                        <form action="pesquisar_placa.php" method="post">
                            <div class="input-field col s12">
                                <input placeholder="Ex: HHH3366" id="first_name" name="placa_pesq" type="text" class="validate">
            ...
            <thead class="highlight red white-text">
              ...
              <?php 
                require './conexao.php';
                $placa_pesq= @$_POST['placa_pesq'];
                $consultar= "SELECT * FROM ordemservico WHERE placa LIKE '%$placa_pesq%' OR placa LIKE '%$placa_pesq%'";
