 ...
 <?php 
    ...
    <div class="z-depth-4" id="tabela">
        <table class="responsive-table z-depth-4 centered #00695c teal darken-3">
            <center><h3><i class="material-icons  medium">search</i>Pesquisar os por nome do mecanico </h3></center>
            
            <div class="container">
                <div class="col s12" id="kk">  
                    <div class="row">
                        <form action="pesquisar_mecanico.php" method="post">
                            <div class="input-field col s12">
                                <input placeholder="Ex: HHH3366" id="first_name" name="nome_mecanico_pesq" type="text" class="validate">
                               <label for="first_name">Nome do Mecanico</label>
                            </div>
                            <center>
            ...
            <thead class="highlight red white-text">
              ...
              <?php 
                require './conexao.php';
                $nome_mecanico_pesq= @$_POST['nome_mecanico_pesq'];
                $consultar= "SELECT * FROM ordemservico WHERE funcionario LIKE '%$nome_mecanico_pesq%' OR funcionario LIKE '%$nome_mecanico_pesq%'";
        ...
        <div class="container  z-depth-4">
            <div class="row">
            	<div class="col l6 s12">
                	<center><h5 class="white-text">GC Desenvolvimento de Sistemas WEB</h5></center>
              </div>
